...
public class ProductTechnologyService {
    ...
    /**
     * 设置工艺选择的锁与输入框状态方法
     * @param productTechnologySonData
     * @return
     */
    @CacheEvict(allEntries = true)
    public int setLockOrInputStatus(productTechnologySon productTechnologySonData){
        return productTechnologySonMappers.updateBySelective(productTechnologySonData);
    }
}
