...
public class RedisConfiguration extends CachingConfigurerSupport{
   ...
   /* @Bean
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        *//* 配置test的超时时间为120s*//*
        RedisCacheManager cacheManager = RedisCacheManager.builder(RedisCacheWriter.lockingRedisCacheWriter
                ...
                ("Yibaier", RedisCacheConfiguration.defaultCacheConfig().entryTtl(Duration.ofSeconds(120L))
    ...
    private Map<String, RedisCacheConfiguration> getRedisCacheConfigurationMap() {
        ...
        redisCacheConfigurationMap.put("SsoCache", this.getRedisCacheConfigurationWithTtl(120));
